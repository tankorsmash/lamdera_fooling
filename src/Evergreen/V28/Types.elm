...
import Evergreen.V28.ClickPricing
import Evergreen.V28.External.Animator.Animator
import Lamdera
import Time
import UUID
import Url
...
type alias UserData = 
    ...
    , userId : UUID.UUID
    , currentLevels : Evergreen.V28.ClickPricing.CurrentLevels
    }
...
type alias CyclingTimeline = ((Evergreen.V28.External.Animator.Animator.Timeline Int), Int)


type alias Timelines = 
    { userClicksTimeline : (Evergreen.V28.External.Animator.Animator.Timeline (Maybe LabelValue))
...
type UpgradeType
    = Discussion Evergreen.V28.ClickPricing.Level
    | Argumentation Evergreen.V28.ClickPricing.Level
    | Energization Evergreen.V28.ClickPricing.Level
    | EnergizeCap Evergreen.V28.ClickPricing.Level
    | ClickCap Evergreen.V28.ClickPricing.Level
