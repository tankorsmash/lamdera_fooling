...
import Evergreen.V32.ClickPricing
import Evergreen.V32.External.Animator.Animator
import Lamdera
import Random
import Time
import UUID
...
type alias UserData = 
    ...
    , userId : UUID.UUID
    , currentLevels : Evergreen.V32.ClickPricing.CurrentLevels
    }
...
type alias CyclingTimeline = ((Evergreen.V32.External.Animator.Animator.Timeline Int), Int)


type alias Timelines = 
    { userClicksTimeline : (Evergreen.V32.External.Animator.Animator.Timeline (Maybe LabelValue))
...
type UpgradeType
    = Discussion Evergreen.V32.ClickPricing.Level
    | Argumentation Evergreen.V32.ClickPricing.Level
    | Energization Evergreen.V32.ClickPricing.Level
    | EnergizeCap Evergreen.V32.ClickPricing.Level
    | ClickCap Evergreen.V32.ClickPricing.Level
